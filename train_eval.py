...
def args_parser():
    ...
    parser.add_argument('--dataset_path', '-dp', default='', help='the path of vimeo-90k')
...
def train(args):
    ...
    data_set = Video_Provider(
        ...
        source_path='F:/dataset_VQM/training/source',
        target_path='F:/dataset_VQM/training/target'
    )
